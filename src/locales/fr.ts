...
const fr: AppText = {
  ...
  simulation: {
    ...
    noteLine3:
      "Final simulé = points actuels + bonus de première capture en attente + production future jusqu'Ã  la fin du Jour 3.",
    bastions: "Bastions",
    valkyries: "Valkyries",
    temple: "Temple",
    ...
    simulatedScoreEvolutionSubtitle:
      "Croissance du score Ã  partir de maintenant jusqu'Ã  la fin du Jour 3, en utilisant la possession simulée.",
  },
  home: {
    title: "MF69 Toolkit",
  ...
  setupVisual: {
    ...
    nextStepBody:
      "Nous allons remplacer cette configuration par une version basée sur la carte, où vous attribuez chaque tribu directement Ã  un home spot.",
  ...
  simulationVisual: {
    ...
    subtitle:
      "Structure de base prête. Ensuite, nous relierons la configuration visuelle Ã  la carte puis Ã  la possession des ruines et des passages.",
