...
const pt: AppText = {
  common: {
    ...
    back: "Voltar",
    continue: "Continuar",
    copyCurrentToSimulation: "Copiar estado atual para a simulação",
  ...
  setup: {
    ...
    subtitle:
      "A Tribo 1 é sempre MF69. Escolhe os nomes, as cores e os pontos atuais das restantes tribos.",
